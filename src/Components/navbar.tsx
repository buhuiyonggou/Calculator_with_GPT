...
const Navbar: React.FC<NavbarProps> = ({ returnLoginPage , serverSelector, serverSelected}) => {
            ...
            <div className="topnav">
                ...
                <div className="dropdown">
                    ...
                    <div className="dropdown-content">
                        <a href="#" onClick={onButtonClick}>localhost</a>
                        <a href="#" onClick={onButtonClick}>renderhost</a>
                    </div>
                </div>
            </div>
        </div>
